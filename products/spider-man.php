    ...
    <div class="main-container">
        <div class="left-column">
            <div class="game-image-container">
                ...
                <img id="mainImage" src="../src/Capas/spiderman/capa.jpg" alt="red dead">
                <button class="nav next" id="next">&#10095;</button>
            </div>
            <div class="thumbnails">
                <img class="thumb active" src="../src/Capas/spiderman/capa.jpg" alt="Thumbnail 1"
                    onclick="changeImage('../src/Capas/spiderman/capa.jpg', this)">
